...
// if($_GET){
    ...
    $informes = array(
        ...
        array(
            ...
            "nombre_curso" => "Química Orgánica",
            "nota" => 75,
            "hora" => 12
        ),
        array(
            "nombre" => "Ana Fernández",
            "nombre_curso" => "Física Cuántica",
            "nota" => 92,
            "hora" => 10
        ),
        array(
            "nombre" => "Luis Martínez",
            "nombre_curso" => "Literatura Española",
            "nota" => 88,
            "hora" => 14
        ),
        array(
            "nombre" => "Laura Sánchez",
            "nombre_curso" => "Biología Molecular",
            "nota" => 79,
            "hora" => 11
        ),
        array(
        ...
        array(
            "nombre" => "Elena Gómez",
            "nombre_curso" => "Economía Internacional",
            "nota" => 87,
            "hora" => 13
        ),
        array(
            "nombre" => "Ricardo Torres",
            "nombre_curso" => "Derecho Constitucional",
            "nota" => 91,
            "hora" => 16
        ),
        array(
            "nombre" => "Marta Ruiz",
            "nombre_curso" => "Psicología Clínica",
            "nota" => 95,
            "hora" => 7
        )
    );
    ...
    foreach($informes as $res){ $i++;

        $name = $texto_formateado = ucwords(strtolower($res["nombre"]));;
        $nameCourse = $res["nombre_curso"];
        $type = $res["tipo"];
        $hours = $res["horas"];
