...
if($_POST){
    ...
    if($nombre && $email && $curso && $duda_comentario){
        ...
        insertarEnColaCorreo($GLOBALS['tipoCorreos'][6], '', '', '<p>Adjuntamos el siguiente formulario de contacto desde la Academia FIPI:</p><br/><ul><li>Nombre: '.$nombre.'</li><li>Email: '.$email.'</li><li>Teléfono: '.$telefono.'</li><li>Curso: '.$curso.'</li><li>Duda/Comentario: '.$duda_comentario.'</li></ul>');
