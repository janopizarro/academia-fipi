...
add_action('admin_menu', 'register_encuesta_sincronica_resultados_page');

function register_encuesta_sincronica_resultados_page() {
  add_submenu_page( 'edit.php?post_type=encuesta_sincronico', 'Resultados (2022)', 'Resultados (2022)', 'manage_options', 'encuesta_sincronica_resultados', 'encuesta_sincronica_resultados_page_callback' ); 
}

function encuesta_sincronica_resultados_page_callback() {
